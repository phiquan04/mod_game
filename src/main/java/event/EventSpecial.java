...
//            System.out.println(money);
            if (p.getBeri0() < money) {
                Service.send_box_ThongBao_OK(p, "Bạn không đủ " + money + " Beri nạp để tham gia tài xỉu. Beri nạp hiện tại: " + p.getBeri0()
                        + ". Yêu cầu beri nạp trên " + money + " mới có thể tiếp tục tham gia tài xỉu");
                return;
            }
            if (p.get_vang() < money) {
                Service.send_box_ThongBao_OK(p, "Bạn không đủ " + money + " beri để tham gia tài xỉu. Beri hiện tại: " + p.get_vang()
                        + ". Yêu cầu beri trên " + money + " mới có thể tiếp tục tham gia tài xỉu");
                return;
            }
