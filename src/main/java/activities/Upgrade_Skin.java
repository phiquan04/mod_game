        ...
        if (m2.reader().available() == 6) {
            ...
            if (type == 1 && cat == 105 && pos == 0 && bovao == 1) {
                        ...
                        for (int i = 0; i < p.upgrade_skin.upgrade_skin_data.length; i++) {
                            if (p.upgrade_skin.upgrade_skin_data[i] != -1
                                ...
                                percent0 = (percent0 * PERCENT[Rebuild_Item
                                        .get_percent_hop_ngoc(p.upgrade_skin.upgrade_skin_data[i])])
                                        / PERCENT[5];
                                //
                                percent2 += percent0;
                            }
                        ...
                        for (int i = 2; i < p.upgrade_skin.upgrade_skin_data.length; i++) {
                            if (p.upgrade_skin.upgrade_skin_data[i] != -1) {
                                if (p.item.total_item_bag_by_id(4,
                                        p.upgrade_skin.upgrade_skin_data[i]) > 0
                                        && p.upgrade_skin.upgrade_skin_data[i] < 80
                                        && check_id_ngoc(p.upgrade_skin.upgrade_skin_data[i])) {
                                    int percent = get_percent(p.upgrade_skin.skin.level);
                                    percent += p.upgrade_skin.skin.level * 4;
                                    percent /= 4;
                                    percent = (percent * PERCENT[Rebuild_Item.get_percent_hop_ngoc(
                                            p.upgrade_skin.upgrade_skin_data[i])]) / PERCENT[5];
                                    percent += 1;
                                    //
                                    m = new Message(81);
                                    m.writer().writeByte(1);
                ...
                if (p.item.total_item_bag_by_id(4, id) > 0 && p.upgrade_skin != null
                    ...
                    percent /= 4;
                    percent =
                            (percent * PERCENT[Rebuild_Item.get_percent_hop_ngoc(id)]) / PERCENT[5];
                    Message m = new Message(81);
                    m.writer().writeByte(1);
                    m.writer().writeByte(4);
                    m.writer().writeShort(id);
                        ...
                        if (p.upgrade_skin != null && p.upgrade_skin.skin != null) {
                            for (int i = 0; i < p.upgrade_skin.upgrade_skin_data.length; i++) {
                                if (p.upgrade_skin.upgrade_skin_data[i] != -1
                                    ...
                                    percent0 /= 4;
                                    percent0 =
                                            (percent0 * PERCENT[Rebuild_Item.get_percent_hop_ngoc(
                                                    p.upgrade_skin.upgrade_skin_data[i])])
                                                    / PERCENT[5];
                                    //
                                    percent2 += percent0;
                                }
            ...
            if (type == 2) {
                ...
                if (p.upgrade_skin != null && p.upgrade_skin.skin != null) {
                    for (int i = 0; i < p.upgrade_skin.upgrade_skin_data.length; i++) {
                        if (i == 0 && (p.upgrade_skin.upgrade_skin_data[i] == 16
                                || p.upgrade_skin.upgrade_skin_data[i] == 17)) {
                            if (p.item.total_item_bag_by_id(7,
                                    p.upgrade_skin.upgrade_skin_data[i]) < 1) {
                                check = false;
                                break;
                            }
                        } else if (p.upgrade_skin.upgrade_skin_data[i] != -1
                                && p.upgrade_skin.upgrade_skin_data[i] < 80
                                && check_id_ngoc(p.upgrade_skin.upgrade_skin_data[i])) {
                            if (p.item.total_item_bag_by_id(4,
                                    p.upgrade_skin.upgrade_skin_data[i]) < 1) {
                ...
                if (p.upgrade_skin != null && p.upgrade_skin.skin != null) {
                    for (int i = 0; i < p.upgrade_skin.upgrade_skin_data.length; i++) {
                        if (i == 0 && (p.upgrade_skin.upgrade_skin_data[1] == 16
                                || p.upgrade_skin.upgrade_skin_data[1] == 17)) {
                            p.item.remove_item47(7, p.upgrade_skin.upgrade_skin_data[1], 1);
                            nl += ((p.upgrade_skin.upgrade_skin_data[1] == 16) ? "sao 8 cánh, "
                                    : "bảo thạch mm, ");
                        } else if (p.upgrade_skin.upgrade_skin_data[i] != -1
                                && p.upgrade_skin.upgrade_skin_data[i] < 80
                                && check_id_ngoc(p.upgrade_skin.upgrade_skin_data[i])) {
                            ...
                            //
                            percent += percent0;
                            p.item.remove_item47(4, p.upgrade_skin.upgrade_skin_data[i], 1);
                            nl += ItemTemplate4.get_item_name(p.upgrade_skin.upgrade_skin_data[i])
                                    + ", ";
                        }
                    }
                }
                ...
                p.update_money();
                if (p.upgrade_skin.upgrade_skin_data[1] == 16) {
                    percent *= 2;
                } else if (p.upgrade_skin.upgrade_skin_data[1] == 17) {
                    percent *= 3;
                }
