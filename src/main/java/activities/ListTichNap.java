...
public class ListTichNap {
  ...
  static {
    ...
    t.num = 20_000;
    t.cat = new byte[] {4, 4 ,7};
    t.id = new short[] {0, 1 ,10};
    t.quant = new short[] {10, 5000, 10};
    ENTRY.add(t);
    //
    ...
    t = new ListTichNap();
    t.num = 100_000;
    t.cat = new byte[] {4, 4, 4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0, 158, 222, 366, 697, 160, 800, 801, 802};
    t.quant = new short[] {10, 5, 50, 10, 5, 1, 1, 1, 1};
    ENTRY.add(t);
    
    t = new ListTichNap();
    t.num = 120_000;
    t.cat = new byte[] {4,7,4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0,10,1, 158, 222, 366, 697, 160, 800};
    t.quant = new short[] {10,10,10000, 5, 50, 10, 5, 1, 1};
    ENTRY.add(t);
    
    t = new ListTichNap();
    t.num = 150_000;
    t.cat = new byte[] {4,4,7, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0,1,10, 158, 222, 366, 697, 160, 800};
    t.quant = new short[] {10,15000,10, 5, 50, 10, 5, 1, 1};
    ENTRY.add(t);
    //
    t = new ListTichNap();
    t.num = 200_000;
    t.cat = new byte[] {4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0, 158, 222, 364, 1003, 697, 800};
    t.quant = new short[] {60, 10, 100, 20, 1, 10, 1};
    ENTRY.add(t);
    ...
    t.cat = new byte[] {4,4,7, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0,1,10, 158, 222, 366, 697, 160, 800};
    t.quant = new short[] {10,20000,20, 5, 50, 10, 5, 1, 1};
    ENTRY.add(t);
    ...
    t.cat = new byte[] {4,4,7, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0,1,10, 158, 222, 366, 697, 160, 800};
    t.quant = new short[] {10,30000,30, 5, 50, 10, 5, 1, 1};
    ENTRY.add(t);
    //
    t = new ListTichNap();
    t.num = 500_000;
    t.cat = new byte[] {4, 4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0, 158, 222, 364, -10, 339, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {150, 20, 30, 30, 20, 10, 20, 1};
    ENTRY.add(t);
    
    t = new ListTichNap();
    t.num = 600_000;
    t.cat = new byte[] {4,7,4, 4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0,10,1, 158, 222, 364, -10, 339, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {150,30,30000, 20, 30, 30, 20, 10, 20, 1};
    ENTRY.add(t);
    ...
    t.id = new short[] {0,10,1, 158, 222, 364, -10, 339, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {150,70,30000, 20, 30, 30, 20, 10, 20, 1};
    ENTRY.add(t);
    //
    t = new ListTichNap();
    t.num = 1_000_000;
    t.cat = new byte[] {4, 4, 4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0, 158, 226, 323, -10, 1002, 455, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {300, 40, 100, 5, 50, 1, 5, 50, 1};
    ENTRY.add(t);
    ...
    t.id = new short[] {0,10,1, 158, 222, 364, -10, 339, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {150,200,30000, 20, 30, 30, 20, 10, 20, 1};
    ENTRY.add(t);
    //
    t = new ListTichNap();
    t.num = 2_000_000;
    t.cat = new byte[] {4, 4, 4, 4, 4, 4, 4, 4};
    t.id = new short[] {0, 427, 226, 323, -10, 1002, 455, 724};
    // -10 ruong cam theo lv
    t.quant = new short[] {600, 1, 100, 10, 100, 2, 20, 100};
    ENTRY.add(t);
    ...
    t.id = new short[] {0,10,1, 158, 222, 364, -10, 339, 697, 800};
    // -10 ruong cam theo lv
    t.quant = new short[] {150,1000,30000, 20, 30, 30, 20, 10, 20, 1};
    ENTRY.add(t);
    //
    t = new ListTichNap();
    t.num = 5_000_000;
    t.cat = new byte[] {4,7, 4, 4, 4, 4, 4, 4, 4, 4,4};
    t.id = new short[] {0,10, 427, 323, -10, 1002, 455, 1004, 325, 724,823};
    // -10 ruong cam theo lv
    t.quant = new short[] {1_000,2000, 1, 30, 100, 5, 40, 10, 10, 200,5};
    ENTRY.add(t);
  }
