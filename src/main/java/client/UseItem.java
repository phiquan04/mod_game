        ...
        if (it_temp != null) {
            if (it_temp.type == 1 || it_temp.type == 2) { // item hp mp
                ...
                switch (id) {
                    ...
                    case 413: { // tien cap don
                        if (p.level == 100) {
                            long xpReq = Level.LEVEL_THONGTHAO[p.thongthao] - p.exp;
                            p.update_exp(xpReq, false);
                            Service.send_box_ThongBao_OK(p, "Dùng tiến cấp đơn thành công");
                        } else {
                            long xpReq = Level.ENTRYS[p.level - 1].exp - p.exp;
                            p.update_exp(xpReq, false);
                            Service.send_box_ThongBao_OK(p, "Dùng tiến cấp đơn thành công");
                        }
                        break;
                    ...
                    case 414: { // ky nang don
                        if (p.level < 20) {
                            Service.send_box_ThongBao_OK(p, "yêu cầu lv20");
                            return false;
                        }
                    ...
                    case 455: {
                       ...
                       case 823: {
                        ...
                        int random_color
                                = (10 > Util.random(1200)) ? 3 : ((50 > Util.random(1200)) ? 2 : 1);
                        for (int i = 0; i < p.skill_point.size(); i++) {
                            if (p.skill_point.get(i).temp.indexSkillInServer == 666) {
                                random_color = (70 > Util.random(1000)) ? 3 : 2;
                                break;
                            }
                        }
                        int id_random = 0;
                        switch (random_color) {
                            case 1: {
                                id_random = (5 > Util.random(120)) ? 12017
                                        : ((20 > Util.random(120)) ? 12018
                                        : ((40 > Util.random(120)) ? 12019 : 12020));
                                break;
                            }
                            case 2: {
                                id_random = (5 > Util.random(120)) ? 12021
                                        : ((20 > Util.random(120)) ? 12022
                                        : ((40 > Util.random(120)) ? 12023: 12024));
                                break;
                            }
                            case 3: {
                                id_random = (5 > Util.random(120)) ? 12025
                                        : ((20 > Util.random(120)) ? 12026
                                        : ((40 > Util.random(120)) ? 12027 : 12028));
                                break;
                            }
                        }
                       }
                        ...
                        switch (random_color) {
                            case 1: {
                                id_random = (5 > Util.random(120)) ? 12034
                                        : ((20 > Util.random(120)) ? 12034
                                        : ((40 > Util.random(120)) ? 12034 : 12034));
                                break;
                            }
                            case 2: {
                                id_random = (5 > Util.random(120)) ? 12034
                            ...
                            case 3: {
                                id_random = (2 > Util.random(120)) ? 12033
                                        : ((20 > Util.random(120)) ? 12034
                                        : ((40 > Util.random(120)) ? 12034 : 12034));
                                break;
                            }
                    ...
                    case 1001: {
                        ...
                        String[] listSelect = new String[listId.length];
...
private static void open_box2(Player p, byte type, int level) throws IOException {
        switch (type) {
            case 22: {
                int bound1 = ((level / 10) * 192) + 2112, bound2 = (((level / 10) + 1) * 192) + 2112 + 70;
                List<Item_wear> list_receiv = new ArrayList<>();
                Item_wear temp = new Item_wear();
                int id_add = 0;
                if (90 > Util.random(120)) { // cung he
...
private static void increaseOptions(Item_wear item) {
    int numOptionsToAdd = Util.random(1, 5);
    for (int i = 0; i < numOptionsToAdd; i++) {
        ...
        int newParam = currentParam + Util.random(1, 5);
